        ...
        <footer className="footer">
            <div className="wrapper">
                ...
                <div className="footer-section">
                    ...
                    <a className="footer-link" target="_blank" rel="noopener" href="https://www.tnpublicnotice.com/">Public Notices</a>
                    <a className="footer-link" href="https://www.shackelfordfuneraldirectors.com/obituaries/" target="_blank" rel="noopener">Obituaries</a>
                </div>
                <div className="footer-section">
